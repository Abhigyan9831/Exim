...
import { Paperclip, Mic, Send, Info, Bot, X } from 'lucide-react';
...
const FloatingAiAssistant: React.FC<FloatingAiAssistantProps> = ({
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      {/* Floating 3D Glowing AI Logo - only visible when closed */}
      {!isChatOpen && (
        <button 
          className="floating-ai-button relative w-16 h-16 rounded-full flex items-center justify-center transition-all duration-500 transform rotate-0"
      ...
      {isChatOpen && (
        <div 
          ref={chatRef}
          className="absolute bottom-0 right-0 w-[90vw] md:w-[500px] transition-all duration-300 origin-bottom-right"
          style={{
